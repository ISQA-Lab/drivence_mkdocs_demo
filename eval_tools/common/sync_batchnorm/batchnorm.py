...
class _SynchronizedBatchNorm(_BatchNorm):
    ...
    def forward(self, input):
        # If it is not parallel computation or is in evaluation mode, use PyTorch's lidar_core.
...
class SynchronizedBatchNorm1d(_SynchronizedBatchNorm):
    ...
    training, PyTorch's lidar_core normalize the tensor on each device using
    ...
    as the built-in PyTorch lidar_core.
